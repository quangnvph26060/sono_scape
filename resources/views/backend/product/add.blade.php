...
@section('content')
    ...
    <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data" id="addproduct">
        @csrf
        <div class="row">
            <!-- Cột bên trái -->
            <div class="col-lg-6 add_product">
                ...
                <div>
                    ...
                    <input type="number" class="form-control" name="condition_level" id="condition_level" min="1"
                        max="100" required>
                </div>
            </div>
            ...
            <div class="col-lg-6 add_product">
                ...
                <div>
                    ...
                    <input type="text" class="form-control" name="source" id="source"
                        placeholder="Nhập nguồn sản phẩm" required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" class="form-control" name="guarantee" id="guarantee"
                        placeholder="Nhập số tháng bảo hành" required>
                </div>
                <div>
